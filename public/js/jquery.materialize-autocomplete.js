(function (root, factory) {
    ...
    Autocomplete.defaults = {
        ...
        appender: {
            ...
            tagTemplate: '<div class="chip" data-id="<%= item.id %>" data-text="<%= item.text %>"><b><%= item.text %></b> <%= item.highlights %><i class="material-icons close">close</i></div>'
        },
        dropdown: {
            el: '',
            tagName: 'ul',
            className: 'ac-dropdown',
            itemTemplate: '<li class="ac-item" data-id="<%= item.id %>" data-text="<%= item.text %>"><a href="javascript:void(0)"><b><%= item.text %></b> <br /><%= item.highlights %> </a></li>',
            noItem: ''
        },
